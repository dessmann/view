...
public class CircleProgress extends View {
    ...
    public Paint getmPaintProgress() {
        return mPaintProgress;
    }

    public void setmPaintProgress(Paint mPaintProgress) {
        this.mPaintProgress = mPaintProgress;
    }

    public Paint getmPaintText() {
        return mPaintText;
    }

    public void setmPaintText(Paint mPaintText) {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        textSize = DensityUtil.sp2px(context, typedArray.getFloat(R.styleable.CircleProgress_textSize, 18f));
        typedArray.recycle();
    }
...
//        canvas.drawText(text, mWidth / 2 - mPaintText.measureText(text) / 2, mHeight / 2 - (mPaintText.descent() + mPaintText.ascent()) / 2, mPaintText);
    }
