...
import com.dsm.view.calender.bean.CalenderBean;
import com.dsm.view.calender.util.CalenderUtil;
...
public class CalenderItemView extends View {
    ...
    //TODO 界面要求行高
    private int itemHeight = sp2px(40);
    ...
    private void drawHeader(Canvas canvas) {
        drawOneText(canvas, "日", itemWidth / 2, itemWidth / 2, headerPaint);
        drawOneText(canvas, "一", itemWidth / 2 + itemWidth, itemWidth / 2, headerPaint);
