...
public class PwdEditText extends AppCompatEditText {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        bgColor = typedArray.getColor(R.styleable.PwdEditText_bgColor, ContextCompat.getColor(getContext(), R.color.backgroundColor));
        borderCornerRadius = typedArray.getFloat(R.styleable.PwdEditText_borderCornerRadius, 10f);
        passwordLength = typedArray.getInteger(R.styleable.PwdEditText_passwordLength, 6);
        lineWidth = typedArray.getFloat(R.styleable.PwdEditText_lineWidth, 1f);
        ...
        showContent = typedArray.getBoolean(R.styleable.PwdEditText_showContent, true);
        typedArray.recycle();
    }
...
//        canvas.drawRoundRect(0, 0, mWidth, mHeight, borderCornerRadius, borderCornerRadius, bgPaint);
        canvas.drawRoundRect(rectF, borderCornerRadius, borderCornerRadius, bgPaint);
        //绘制边框
